 ...
 * from this project's own copy of `docs/02_privacy-policy.md`
 * (specs/031-privacy-policy).
 *
 ...
 *   (FR-005, FR-006; Assumptions) rather than rendered as literal brackets.
 *
 * Editing the legal substance beyond those specific fallbacks is out of scope
 * for this file (FR-012) — any future correction is ACRET/legal counsel's
 * call, made by editing docs/02_privacy-policy.md first and this
...
/** Resolved fallbacks for the source document's unresolved placeholders (FR-005, FR-006). */

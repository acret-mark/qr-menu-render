# Hapag Privacy Policy

**Effective Date:** August 19, 2026 [placeholder — set to actual publish date]
**Last Updated:** August 19, 2026 [placeholder — set to actual publish date]

> ⚠️ **Drafting note (remove before publishing):** This document was drafted from the current Hapag QR codebase and planning documents. Bracketed items like `[ACRET legal entity name]` must be filled in — ideally after registering with the National Privacy Commission (NPC) as a Personal Information Controller under RA 10173, and after formal DTI/SEC business registration. Have this reviewed by a Philippine lawyer before publishing, especially the data subject rights and retention sections.
...
> **Quick Summary (not a substitute for the full Policy below):** If you're a Business Owner, we collect your account, business, and payment-verification details to run your menu and subscription. If you're a Customer scanning a QR code, we don't collect anything beyond a language-preference cookie. We never sell your data. Full details, your rights, and how to contact us are below.

**Jump to a section:** [Who We Are](#2-who-we-are) · [Who This Applies To](#3-who-this-policy-applies-to) · [Information We Collect](#4-information-we-collect) · [How We Use It](#5-how-we-use-your-information) · [Legal Basis](#6-legal-basis-for-processing) · [Cookies](#7-cookies-and-similar-technologies) · [How We Share It](#8-how-we-share-your-information) · [Security & Storage](#9-data-storage-security-and-international-transfer) · [Retention](#10-data-retention) · [Your Rights](#11-your-rights-as-a-data-subject) · [Children](#12-childrens-privacy) · [Third-Party Links](#13-third-party-links-and-content) · [Changes](#14-changes-to-this-policy) · [Contact Us](#15-contact-us)
...
### 4.1 Information Business Owners Provide Directly
...
### 4.3 Information We Do Not Collect from Customers
...
1. Create and manage Business Owner accounts and authenticate logins;
2. Generate, host, and display your digital menu and QR code;
3. Provide Pro-tier features such as AI-assisted menu descriptions and machine translation;
4. Verify proof-of-payment submissions and activate, renew, or suspend subscriptions;
5. Send transactional communications (e.g., welcome emails, payment confirmations, renewal reminders, and responses to support tickets);
6. Detect, investigate, and prevent fraud, abuse, and security incidents;
7. Comply with our legal, tax, and regulatory obligations (e.g., issuing BIR-compliant receipts and maintaining financial records); and
8. Improve and maintain the reliability of the Service.
...
- **Compliance with a legal obligation** — for tax, accounting, and regulatory record-keeping; and
...
|---|---|---|---|
| `hapag_lang` | Remembers a menu viewer's selected display language | 1 year | Strictly functional (not tracking/advertising) |
...
| Category of Provider | Purpose | Data Involved |
|---|---|---|
| Database and authentication hosting | Storing account, business, and menu data; logging you in securely | Account credentials, business data, uploaded files |
| Image hosting | Hosting logos and menu photos | Uploaded images |
| Transactional email delivery | Sending account, payment, and support emails | Email address, email content |
| Website hosting and content delivery | Serving the Service to your browser | Technical/log data |
| Machine translation (Pro plan only) | Translating menu content into other languages | Menu item/category text |
| AI content generation (Pro plan only) | Generating AI-assisted menu descriptions | Item name and keywords you supply |
...
- To protect the rights, property, or safety of ACRET, our users, or the public; or
...
- Restricted, logged access for ACRET admin staff; and
- Regular backups.
...
- **Damages** for harm sustained due to inaccurate, incomplete, outdated, false, unlawfully obtained, or unauthorized use of personal data; and
- **File a complaint** with the National Privacy Commission (www.privacy.gov.ph) if you believe your rights have been violated.
...
**[Data Protection Officer / Privacy Contact Name]**
**ACRET — Hapag**
Email: **privacy@hapag.ph**
Address: **14th Floor, Latitude Corporate Center, Cebu Business Park, Lahug, Cebu City, 6000 Cebu, Philippines**

You may also file a complaint with the **National Privacy Commission** at [www.privacy.gov.ph](https://www.privacy.gov.ph).
